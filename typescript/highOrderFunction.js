...
// var yearsPlayed = players.map((player)=>{
...
// var sortTotalScores = players.sort((player1,player2)=>{
...
//5.reduce
var sumScores1 = players.reduce(function (cumTotal, player) {
    return ((cumTotal + player.total_runs));
}, 0);
